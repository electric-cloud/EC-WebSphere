...
@Stepwise
class CreateOrUpdateWMQActivationFactorySuite extends PluginTestHelper {
    ...
    @Shared
    def testProcedureName = 'CreateOrUpdateWMQActivationFactorySuite'
    ...
    */
    ...
    @Shared // Required Parameter (need incorrect and empty value)
    def connectionFactoryAdministrativeNames = [
        empty:                          '',
        correct:                        '',
        incorrect:                      '',
    ]
    ...
    @Shared // Required Parameter (need incorrect and empty value)
    def connectionFactoryTypes = [
        empty:                          '',
        correct:                        'com.jndi.myWMQFactType',
        incorrect:                      'incorrect connection Factory Type',
    ]
    
    @Shared // Required Parameter (need incorrect and empty value)
    def jndiNames = [
        empty:                          '',
        correct:                        'com.jndi.myWMQFact',
        incorrect:                      'incorrect JNDI Name',
    ]

        // Not required Parameter
    @Shared // Optional Parameter
    def connectionFactoryAdministrativeDescriptions = [
        empty:                          '',
        correct:                        'connection Factory Administrative Description',
        incorrect:                      '',
    ]
    ...
    */
    ...
    def connectionFactoryScope
    def connectionFactoryAdministrativeName
    def connectionFactoryType
    def jndiName

    def connectionFactoryAdministrativeDescription
     ...
     */
     ...
     def doSetupSpec() {
        ...
        importProject(testProjectName, 'dsl/CreateOrUpdateWMQActivationFactory/.dsl', [projectName: testProjectName, wasResourceName:wasResourceName])
    ...
    def "Create Or Update WMQ Activation Factory. Positive Scenarios and Extended Scenarios" (){
