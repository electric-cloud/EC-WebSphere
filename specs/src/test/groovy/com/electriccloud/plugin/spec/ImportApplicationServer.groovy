...
class ImportApplicationServer extends PluginTestHelper {
    ...
    def 'ImportApplicationServer - Positive: #testCaseID.id #testCaseID.description'(){
        ...
        testCases.C363401 | confignames.correctSOAP | servers.'default' | ''                  | paths.'default' | ''                   | nodes.'default' | nodes.'1'         | '0'       | servers.'default'  | nodes.'default' | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'default'       
        ...
        testCases.C363435 | confignames.correctSOAP | servers.'default' | servers.'default'   | paths.'backup'  | ''                   | nodes.'default' | nodes.'1'         | '0'       | servers.'default'  | ''              | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'   
        testCases.C363433 | confignames.correctSOAP | servers.'default' | servers.'2'         | paths.'backup'  | ''                   | nodes.'default' | nodes.'1'         | '0'       | servers.'default'  | ''              | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'   
    ...
    def 'ImportApplicationServer - Negative: #testCaseID.id #testCaseID.description'(){
        ...
        testCases.C363448   | confignames.correctSOAP | servers.'default' | servers.'wrong'     | paths.'backup'  | ''                 | nodes.'default' | nodes.'1'         | '1'       | servers.'default'  | nodes.'default' | paths.'default' | "error"     | summaries.'wrongArcServer'         | jobLogs.'wrongArcServer'         | 0    
