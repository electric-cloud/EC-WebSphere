...
//for Queue
            ...
            pluginConfigurationNames.correctSOAP    | specScopes.incorrect          | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.incorrectScope
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.incorrect         | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreateQ
...
//            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.incorrect      | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreateQ
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.incorrect        | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreateQ
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.incorrect        | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreateQ
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.incorrect       | expectedOutcomes.success          | expectedSummaryMessages.successCreateQ
