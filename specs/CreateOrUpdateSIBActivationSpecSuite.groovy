...
class CreateOrUpdateSIBActivationSpecSuite extends PluginTestHelper {
    ...
    */
    ...
    def expectedSummaryMessages = [
        empty:                          "",
        successCreate:                  "SIB JMS Activation Spec $specAdministrativeName has been created",
        successUpdate:                  "SIB JMS Activation Spec $specAdministrativeName has been updated",
...
//for Queue
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.correctQueue   | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.correctQueue     | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.correct          | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            ...
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctQueue      | specJNDINames.correctQueue    | destinationJNDINames.correctQueue      /* Not Required */ | specAdministrativeDescriptions.correctQueue   | destinationTypes.correctQueue     | messageSelectors.correct          | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
//for Topic
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctTopic      | specJNDINames.correctTopic    | destinationJNDINames.correctTopic      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successCreate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctTopic      | specJNDINames.correctTopic    | destinationJNDINames.correctTopic      /* Not Required */ | specAdministrativeDescriptions.correctTopic   | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctTopic      | specJNDINames.correctTopic    | destinationJNDINames.correctTopic      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.correctTopic     | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            ...
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctTopic      | specJNDINames.correctTopic    | destinationJNDINames.correctTopic      /* Not Required */ | specAdministrativeDescriptions.empty          | destinationTypes.empty            | messageSelectors.empty            | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
            pluginConfigurationNames.correctSOAP    | specScopes.correctOneNode     | specAdministrativeNames.correctTopic      | specJNDINames.correctTopic    | destinationJNDINames.correctTopic      /* Not Required */ | specAdministrativeDescriptions.correctTopic   | destinationTypes.correctTopic     | messageSelectors.empty            | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdate
