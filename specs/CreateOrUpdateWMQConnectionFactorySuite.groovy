...
class CreateOrUpdateWMQConnectionFactorySuite extends PluginTestHelper {
    ...
    */
    ...
    def additionalOptions = [
        empty:                          "",
        correct:                        "-ccsid 819 -msgSelection BROKER",
...
//for CF
            ...
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctCF      | factoryTypes.correctCF        | jndiNames.correctCF               | factoryAdministrativeDescriptions.empty           | clientChannelDefinitionUrls.empty         | clientChannelDefinitionQueueManagers.empty        | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctCF      | factoryTypes.correctCF        | jndiNames.correctCF               | factoryAdministrativeDescriptions.correctCF       | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.empty        | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdateCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctCF      | factoryTypes.correctCF        | jndiNames.correctCF               | factoryAdministrativeDescriptions.correctCF       | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdateCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctCF      | factoryTypes.correctCF        | jndiNames.correctCF               | factoryAdministrativeDescriptions.correctCF       | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateCF
//for QCF
            ...
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctQCF     | factoryTypes.correctQCF       | jndiNames.correctQCF              | factoryAdministrativeDescriptions.empty           | clientChannelDefinitionUrls.empty         | clientChannelDefinitionQueueManagers.empty        | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateQCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctQCF     | factoryTypes.correctQCF       | jndiNames.correctQCF              | factoryAdministrativeDescriptions.correctQCF      | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.empty        | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdateQCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctQCF     | factoryTypes.correctQCF       | jndiNames.correctQCF              | factoryAdministrativeDescriptions.correctQCF      | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdateQCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctQCF     | factoryTypes.correctQCF       | jndiNames.correctQCF              | factoryAdministrativeDescriptions.correctQCF      | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateQCF
//for TCF
            ...
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctTCF     | factoryTypes.correctTCF       | jndiNames.correctTCF              | factoryAdministrativeDescriptions.empty           | clientChannelDefinitionUrls.empty         | clientChannelDefinitionQueueManagers.empty        | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateTCF
            ...
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctTCF     | factoryTypes.correctTCF       | jndiNames.correctTCF              | factoryAdministrativeDescriptions.correctTCF      | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.empty           | expectedOutcomes.success          | expectedSummaryMessages.successUpdateTCF
            pluginConfigurationNames.correctSOAP    | factoryScopes.correctOneNode      | factoryAdministrativeNames.correctTCF     | factoryTypes.correctTCF       | jndiNames.correctTCF              | factoryAdministrativeDescriptions.correctTCF      | clientChannelDefinitionUrls.correct       | clientChannelDefinitionQueueManagers.correct      | additionalOptions.correct         | expectedOutcomes.success          | expectedSummaryMessages.successUpdateTCF
    }
