...
class ImportApplicationServerNegative extends PluginTestHelper {
    ...
    @Shared
    def testProcedureName =         'ImportApplicationServer'
    ...
    */
    ...
    def archivePaths = [
        ...
        incorrect: '/does/not/exist/archive123.car'
    ]
    /**
    ...
    */
    ...
    def exs = [
        ...
        wrongPath: "Failed to import application server $serverNames.correct to node $nodeNames.correct",
     ...
     */
     ...
     def doSetupSpec() {
        ...
        // actual test project
        importProject(testProjectName, 'dsl/ImportApplicationServer/Procedure.dsl', [projectName: testProjectName, wasResourceName:wasResourceName])
    ...
    @Unroll
    def "ImportApplicationServer. Negative scenario." () {
        when: 'Procedure runs: '
             def runParams = [
                wasHost:    wasHost,
            configName: cfgName,
        ...
        def jobSummary = getJobProperty('/myJob/jobSteps/ImportApplicationServer/summary', result.jobId)
        ...
        where: 'The following params will be: '
            ...
            pluginConfigurationNames.correctSOAP | archivePaths.incorrect | nodeNames.correct   | serverNames.correct   | exs.wrongPath
