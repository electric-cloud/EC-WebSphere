...
class ImportApplicationServer extends PluginTestHelper {
    ...
    def jobLogs = [
        ...
        'emptyConfig': ["Configuration '' doesn't exist"],
        'incorrectConfig': ["Configuration 'incorrect' doesn't exist"],
        'emptyServer':['Failed to import application server serverReplace to node nodeReplace', 'Required parameter serverName is not found for command exportServer'],
    ...
    def 'ImportApplicationServer - Positive: #testCaseID.id #testCaseID.description'(){
        ...
        testCases.C363401 | confignames.correctSOAP | servers.'default' | ''                  | paths.'default' | ''                   | nodes.'default' | nodes.'default'   | '0'       | servers.'default'  | nodes.'default' | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'default'       
        testCases.C363434 | confignames.correctSOAP | servers.'default' | servers.'default'   | paths.'default' | ''                   | nodes.'default' | ''                | '0'       | servers.'default'  | nodes.'default' | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'    
        testCases.C363435 | confignames.correctSOAP | servers.'default' | servers.'default'   | paths.'backup'  | ''                   | nodes.'default' | nodes.'default'   | '0'       | servers.'default'  | ''              | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'   
        testCases.C363433 | confignames.correctSOAP | servers.'default' | servers.'2'         | paths.'backup'  | ''                   | nodes.'default' | nodes.'default'   | '0'       | servers.'default'  | ''              | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'   
        testCases.C363436 | confignames.correctSOAP | servers.'default' | servers.'3'         | paths.'backup'  | ''                   | nodes.'default' | nodes.'2'         | '0'       | servers.'default'  | ''              | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'serverInArc'   
        testCases.C363437 | confignames.correctSOAP | servers.'default' | ''                  | paths.'default' | coreGroups.'default' | nodes.'default' | ''                | '0'       | servers.'default'  | nodes.'default' | paths.'default' | "success"   | summaries.'default' | 0            | jobLogs.'coreGroup'     
