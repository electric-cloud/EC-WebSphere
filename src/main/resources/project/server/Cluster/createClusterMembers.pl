...
my $step_params = {
    target => {
        pipeline => 'Create Cluster Members Result:',
        success_summary => 'Cluster members have been created.',
        error_summary   => 'Failed to create a cluster members.'
    },
    jython_script => {
        path => 'create_cluster_members.py',
    },
};
